...
const AdminProductDetails = () => {
  ...
  return (
    <div className='grid grid-cols-1 md:grid-cols-6 gap-8 p-8 bg-white w-screen'>
      <div className="image bg-gray-200 w-full md:col-span-1 flex justify-center items-center relative">
      ...
      <div className="md:col-span-5">
        ...
        <span>quantity</span>
        <input onChange={onChange} name="quantity" value={product && product.quantity} className="  border outline-none w-full mt-2 bg-transparent"/>
        </div>
        ...
        <textarea onChange={onChange} rows={5} cols={50} name="description" value={product && product.description} className="  border-none outline-none w-full text-lg mb-8 bg-transparent" />
        ...
        <div className="">
          ...
          <input type="text" value={product && product.associatedBlog} onChange={(e) => setProduct((prev)=>{
            setUpdateable(true)
            return {...prev, associatedBlog: e.target.value}
