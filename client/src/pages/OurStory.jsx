...
const OurStory = () => {
  ...
  return (
    <div className="bg-white text-gray-800 relative overflow-hidden">
          ...
          <div className="max-w-3xl text-center">
            <div className="animate-fadeIn">
              ...
              <p className="text-lg md:text-xl mb-12 leading-relaxed">
                Welcome to Fortune Gate Biodynamic Farm. Since 2016, we've been
                committed to pure, organic milk through sustainable practices
                that honor nature's wisdom.
              </p>
              ...
              <div className="md:col-span-7">
                ...
                <p className="text-lg leading-relaxed text-gray-700 mb-6">
                  <span className="font-bold">
                    In 2012, a realization sparked:{" "}
                  </span>{" "}
                  this treasure trove of knowledge was far too vital to remain
                  hidden. And thus, FORTUNE GATE ORGANIC FARMING (FGOF) was
                  born—not just as a farm, but as a living legacy, proudly
                  standing for the WORLD NO.1 UNIQUE ANCIENT TRADITIONAL
                  METHODS, and the POTENT POWER A2-A2, MILK REVOLUTION.
                </p>
                <div className="bg-green-100 p-6 rounded-lg border-l-4 border-green-600 shadow-sm">
                  <div className="flex items-start">
                    ...
                    <p className="italic text-green-800">
                      "We believe in a holistic approach, where the health of
                      our cows directly influences the purity of our milk. This
                      dedication to quality over quantity means we produce less
                      milk but with unmatched purity and nutritional value."
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-7 md:order-2">
                <div className="space-y-6">
                  <p className="text-lg leading-relaxed">
                    To revive, preserve, and promote the forgotten science of
                    Biodynamic Farming with Indigenous Cows and Seeds, rooted in
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
                      ...
                      <p>
                        We stand firm against artificial enhancers and harmful
                        chemicals. Our cows are fed 100% natural fodders,
                        ensuring our ghee retains its natural benefits and
                        purity.
                      </p>
                    </div>
                    ...
                    <div className="bg-white/10 p-6 rounded-lg backdrop-blur-sm">
                      ...
                      <p>
                        Our ghee, made from the milk of freely grazing cows, is
                        a testament to our commitment to health and tradition,
      ...
      {/* Team Section */}
      <section id="team" ref={sectionRefs.team} className="py-24 px-4 bg-white">
        <div className="container mx-auto">
          <div
            className={`transition-all duration-1000 ${
              isVisible.team
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-20">
              {[
                ...
                },
                {
                  name: "Geegi Kumar",
                  role: "Founder",
                  image: "/images/jijikumar.jpeg",
                },
                {
                  name: "Akash Geegikumar",
                  role: "",
          ...
          >
            ...
            <div className="max-w-lg mx-auto text-center mb-12">
              <p className="text-lg leading-relaxed">
                ...
                or just want to say hello, please reach out to us using the form
                below.
              </p>
            </div>
                ...
                <div className="relative rounded-lg overflow-hidden shadow-xl h-full">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent to-green-900/80 flex items-end">
                    <div className="p-6 text-white">
                      ...
                      <p className="mb-4">
                        Experience the natural beauty and sustainable practices
                        firsthand.
                      </p>
