        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="relative ">
            <img
              ...
              alt="All Products"
              className="w-full max-w-5xl mx-auto rounded-2xl lg:h-[30rem] object-contain"
            />
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="text-center mb-4">
                      <h3 className="text-2xl font-bold green-gradient-text mb-2">
                        {product.name}
                      </h3>
                      <p className="green-gradient-text font-medium">
                        {product.fullName}
                      </p>
                    </div>
