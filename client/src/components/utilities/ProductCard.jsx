    ...
    <Link to={`/products/${product.slug}`} className="block group relative">
      <div className="bg-white border border-gray-100 rounded-xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl hover:-translate-y-1">
        ...
        <div className="p-6">
          ...
          {/* Product Name */}
          <h3 className="font-medium text-xl text-gray-900 mb-3 line-clamp-2 leading-tight">
            {product.name}
          </h3>
          
          {/* Price */}
          <div className="text-xl font-medium text-gray-900 mb-4 tracking-tight">
          ...
          <Link to={`/products/${product.slug}`}
            ...
            className="w-full bg-gradient-to-r from-green-600 to-green-800 text-white text-sm font-semibold py-3 px-4 rounded-lg hover:bg-green-600 transition-all duration-300 flex items-center justify-center gap-2"
          >
